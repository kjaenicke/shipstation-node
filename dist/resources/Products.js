...
var Products = (function (_super) {
    ...
    function Products(shipstation) {
        var _this = _super.call(this, shipstation, 'products') || this;
        _this.shipstation = shipstation;
        return _this;
    }
    Products.prototype.getAll = function (opts) {
    ...
    Products.prototype.update = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var url, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        url = "".concat(this.baseUrl, "/").concat(data.productId);
                        return [4, this.shipstation.request({
                                url: url,
