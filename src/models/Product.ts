...
export interface IProduct {
    aliases: IProductAlias[] | null // An array of aliases for the product.
    ...
    productCategory: (number | string)[] | null // The ProductCategory used to organize and report on similar products.
    ...
    tags: (number | string)[] | null // The ProductTag helps to organize and visually identify products.
}
